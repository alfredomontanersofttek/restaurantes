...
public class Plato {
	...
	public static Plato fromPlatoDAO(com.softtek.restaurant.daos.model.Plato plato) {
	...
	public com.softtek.restaurant.daos.model.Plato toPlatoDAO() {
		...
		return new com.softtek.restaurant.daos.model.Plato(
				this.getId(),
				this.getNombre(),
				this.getPrecio(),
				cat,
