...
public class PlatoDaoImpl implements PlatoDao {
    ...
    @Override
    public Optional<Plato> getPlatoByName(String nombre) {
        Map<String, Object> params = new HashMap<>();
        params.put("nombre", nombre);
        String query = "SELECT id, nombre, precio, categoria, calorias FROM plato WHERE nombre = :nombre";

        try {
            Plato plato = jdbcTemplate.queryForObject(query, params, platoRowMapper);
